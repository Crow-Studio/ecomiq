    ...
    <div className={$headingContainer({ align, className })}>
      ...
      <div
        className={clsx(
          ...
          "[&>*]:text-3xl [&>*]:font-medium [&>*]:text-pretty md:[&>*]:text-4xl",
          {
      ...
      {subtitle ? (
        <p
          className={clsx(
            "max-w-screen-md text-lg font-light text-pretty text-[--text-tertiary] md:text-xl dark:text-[--dark-text-tertiary]",
            {
              "text-center": align === "center",
              "text-left": align === "left",
              "text-right": align === "right",
...
export function Tag({
  ...
  return (
    <Comp
      className={clsx(
        "flex min-h-7 items-center justify-center gap-2 rounded-full bg-[--surface-secondary] px-3.5 pb-px text-sm font-medium text-[--text-tertiary] md:text-base dark:bg-[--dark-surface-secondary] dark:text-[--dark-text-tertiary]",
        className,
      )}
      {...props}
    >
